import os
"""
This module provides functions for interacting with Kubernetes services and resources.
Functions:
- get_namespace(): Retrieves the Kubernetes namespace.
- load_k8s_config(): Loads the Kubernetes configuration.
- get_workflow_pods(workflow_id: str) -> List[client.V1Pod]: Retrieves the pods associated with a specific workflow.
- find_visualization_pod(pods: List[client.V1Pod]) -> Optional[client.V1Pod]: Finds the visualization pod from a list of pods.
- get_visualization_pod_name(workflow_id: str) -> Optional[str]: Retrieves the name of the visualization pod for a specific workflow.
- create_k8s_resources(name: str) -> str: Creates Kubernetes resources (Service and Ingress) for a given name.
- delete_k8s_resources(name: str): Deletes Kubernetes resources (Service and Ingress) for a given name.
"""
import logging
